...
export const zhCN = {
  ...
  remote: {
    ...
    disconnect: '断开',
    reconnect: '重新连接',
    deleteConfirm: '此目标有 {{count}} 个活动会话，确认删除？',
    deleteConfirmTitle: '删除「{{name}}」？',
    importConflict: '冲突策略',
    importConflictSkip: '跳过已有',
    importConflictOverwrite: '覆盖已有',
    importConflictDuplicate: '创建副本',
    ...
    credential: {
      title: 'SSH 认证',
      passwordPrompt: '请输入 {{user}}@{{host}} 的密码',
      passphrasePrompt: '请输入密钥口令',
      submit: '认证',
      cancel: '取消',
    },
    hostKey: {
      unknownTitle: '未知主机密钥',
      unknownMessage: '无法验证主机「{{host}}」的真实性。\n指纹：{{fingerprint}}\n是否继续连接？',
