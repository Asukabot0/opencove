...
export const en = {
  ...
  remote: {
    ...
    reconnect: 'Reconnect',
    deleteConfirm: 'This target has {{count}} active session(s). Delete anyway?',
    deleteConfirmTitle: 'Delete "{{name}}"?',
    importConflict: 'Conflict Strategy',
    importConflictSkip: 'Skip existing',
    importConflictOverwrite: 'Overwrite existing',
    importConflictDuplicate: 'Create duplicate',
    ...
    credential: {
      ...
      passwordPrompt: 'Enter password for {{user}}@{{host}}',
      passphrasePrompt: 'Enter passphrase for key',
      submit: 'Authenticate',
      cancel: 'Cancel',
    },
    hostKey: {
      ...
      mismatchMessage:
        'WARNING: The host key for "{{host}}" has changed!\nThis could indicate a man-in-the-middle attack.\nConnection will be blocked.',
